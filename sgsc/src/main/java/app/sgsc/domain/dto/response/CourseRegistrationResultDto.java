...
public record CourseRegistrationResultDto(
    Long courseId,
    String courseType,
    String courseName,
    String courseNumber,
    ...
    @QueryProjection
    public CourseRegistrationResultDto {
        // ...
    }

    @QueryProjection
    public CourseRegistrationResultDto(Course course, CourseGroup courseGroup, College college, CollegeDivision collegeDivision, CollegeDepartment collegeDepartment) {
